 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".portfolio-page__slider")) new swiper_core_Swiper(".portfolio-page__slider", {
...
***************************************************************************** */
        ...
        da.init();
        let numberOfArticles = document.querySelectorAll(".blog-page__article").length;
        let bgColorsTest = [ "#ee6557", "#bfbfbf", "#19cee2", "#f4e181" ];
        for (let bgTest = 1; bgTest <= numberOfArticles; bgTest++) {
            let colorTest;
            if (bgTest <= 4) colorTest = bgColorsTest[bgTest - 1]; else {
                let colorIndex = Math.floor(Math.random() * bgColorsTest.length);
                colorTest = bgColorsTest[colorIndex];
            }
            let elementTest = document.querySelector(".blog-page__article:nth-child(" + bgTest + ")");
            elementTest.style.background = colorTest;
            elementTest.style.transition = "box-shadow 0.5s";
        }
        window["FLS"] = true;
        menuInit();
        formFieldsInit({
